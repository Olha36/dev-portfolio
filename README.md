<div align="center">
  <br />
    <a href="https://youtu.be/0fYi8SGA20k?feature=shared" target="_blank">
      <img src="https://github.com/Olhahajdin/project_3D_developer_portfolio/assets/151519281/4722160a-8e61-403f-a905-728feae1f7e6" alt="Project Banner">
    </a>
  <br />
  ...
  <h3 align="center">A 3D Developer Portfolio</h3>
   ...
   <div align="center">
     Build this project step by step with our detailed tutorial on <a href="https://www.youtube.com/@javascriptmastery/videos" target="_blank"><b>Portfolio</b></a> YouTube. Join the JSM family!
    </div>
</div>
...
This repository contains the code corresponding to an in-depth tutorial available on our YouTube channel, <a href="https://www.youtube.com/@javascriptmastery/videos" target="_blank"><b>Portfolio</b></a>.
...
```bash
git clone git@github.com:Olhahajdin/project_3D_developer_portfolio.git
...
.golden-gradient {
  background: #fdb931;
  background: linear-gradient(-90deg, #fdb931 0%, rgba(159, 121, 40, 0) 100%);
  background: -webkit-linear-gradient(
    -90deg,
    #fdb931 0%,
    rgba(159, 121, 40, 0) 100%
  );
}
